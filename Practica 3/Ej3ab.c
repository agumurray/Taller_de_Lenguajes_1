...
void inicializarDir(struct direccion*);
...
int main() {
    ...
    printf("Nombre del alumno con mejor promedio: %s\n", mejorProm.nombre);
    printf("Apellido del alumno con mejor promedio: %s\n", mejorProm.apellido);
    printf("Promedio del alumno con mejor promedio: %f\n", mejorProm.promedio);
